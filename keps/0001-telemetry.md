...
Telemetry and analytics are highly important to [Khulnasoft][khulnasoft] to enable us to
better understand our community and customer use-cases and take action to
improve our products. Traditionally telemetry for products like the [Khulnasoft
...
[khulnasoft]:https://khulnasofthq.com
...
As well as several Khulnasoft Specifics:

- Deployment Method
- Last configuration change
- Khulnasoft Plugins Count
- Route Types
...
on `KhulnasoftPlugins`, and particularly the use of custom plugins. Doing telemetry
