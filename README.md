# Khulnasoft Kubernetes Telemetry
![GitHub tag (latest SemVer)](https://img.shields.io/github/v/tag/Khulnasoft/kubernetes-telemetry?label=Latest%20tag)
[![Go Report Card](https://goreportcard.com/badge/github.com/khulnasoft/kubernetes-telemetry)](https://goreportcard.com/report/github.com/khulnasoft/kubernetes-telemetry)
[![Go Reference](https://pkg.go.dev/badge/github.com/khulnasoft/kubernetes-telemetry.svg)](https://pkg.go.dev/github.com/khulnasoft/kubernetes-telemetry)

Toolkit for telemetry data for [Khulnasoft's][khulnasoft] Kubernetes products, such as the
[Khulnasoft Kubernetes Ingress Controller (KIC)][kic].
...
import (
  ...
  "github.com/khulnasoft/kubernetes-telemetry/pkg/forwarders"
  "github.com/khulnasoft/kubernetes-telemetry/pkg/serializers"
  "github.com/khulnasoft/kubernetes-telemetry/pkg/telemetry"
)
...
[khulnasoft]:https://github.com/khulnasoft
