...
const (
	...
	MeshKindKhulnasoftMesh MeshKind = "khulnasoft-mesh"
...
var meshServiceName = map[MeshKind]string{
	...
	MeshKindKhulnasoftMesh: "khulnasoft-mesh-control-plane",
...
var meshPodAnnotations = map[MeshKind]*labels.Requirement{
	...
	MeshKindKhulnasoftMesh: mustMakeRequirement("kuma.io/sidecar-injected", selection.Equals, []string{"true"}),
...
var meshSidecarContainerName = map[MeshKind]string{
	...
	MeshKindKhulnasoftMesh: "kuma-sidecar",
...
var meshInitContainerName = map[MeshKind]string{
	...
	MeshKindKhulnasoftMesh: "kuma-init",
	MeshKindConsul:         "consul-connect-inject-init",
	MeshKindAWSAppMesh:     "proxyinit",
}

var meshKindShortNames = map[MeshKind]string{
	MeshKindIstio:          "i",
	MeshKindLinkerd:        "l",
	MeshKindKuma:           "k",
	MeshKindKhulnasoftMesh: "km",
	MeshKindConsul:         "c",
	MeshKindTraefik:        "t",
	MeshKindAWSAppMesh:     "a",
}
